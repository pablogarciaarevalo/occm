...
^1^ For these sync relationships, you need to link:task_sync_managing_data_brokers.html#configure-the-data-broker-to-copy-object-storage-metadata[modify the data broker's configuration in order to copy metadata].

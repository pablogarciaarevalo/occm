...
NOTE: Cloud Manager doesn't create a storage VM management LIF on HA pairs in a single AZ. You can choose whether to create a management LIF on HA pairs in multiple AZs.

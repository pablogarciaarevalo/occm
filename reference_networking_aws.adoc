...
The following image illustrates the networking requirements specific to an HA pair in multiple AZs: three Availability Zones, three subnets, floating IP addresses, and a route table.

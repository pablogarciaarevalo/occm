...
* You can assign a certain Status to the file. See link:task_managing_highlights.html#applying-status-codes-to-manage-your-scanned-files[applying Status tags] for details.

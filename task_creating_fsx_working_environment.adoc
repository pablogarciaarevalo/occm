...
. Leave _CIDR Range_ empty and click *Next* to automatically set an available range. Optionally, you can use link:task_setting_up_transit_gateway[AWS Transit Gateway] to manually configure a range.
+

...
. If you want to have more secure connectivity over the public internet from your on-prem data center to the VPC, there is an option to select an AWS PrivateLink in the activation wizard. In this case you'll need to have created an endpoint service configuration using the Amazon VPC console or the command line. https://docs.aws.amazon.com/vpc/latest/privatelink/endpoint-service.html[See details about using AWS PrivateLink^].

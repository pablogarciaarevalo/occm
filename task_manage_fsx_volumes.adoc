...
NOTE: You cannot delete a volume that was previously part of a SnapMirror relationship using Cloud Manager. You need to use the AWS Management Console or CLI to delete these volumes. 

...
+
image:screenshot_fsx_connector_prompt.pn[A screenshot of the FSx for ONTAP Connector prompt.]

. Click the *Volumes* tab

. Click *Add Volume*.
+
image:screenshot_fsx_volume_new.pn[A screenshot of the FSx for ONTAP volume tab.]
...
.. Click *Next*.
+
image:screenshot_fsx_volume_details.pn[A screenshot of the volume details and protection fields for FSx for ONTAP volume creation.]

. *Protocol*: Select the NFS versions and Access Control policy. Optionally, specify a custom export policy. Click *Next*.
+
image:screenshot_fsx_volume_nfs_only.pn[A screenshot of volume protocol fields for NFS.]
...
.. Click *Next*.
+
image:screenshot_fsx_volume_usage_tiering.pn[A screenshot of the Usage Profile and Tiering Configuration for FSx for ONTAP volume creation.]

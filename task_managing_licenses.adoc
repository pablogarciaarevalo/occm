...
+
image:screenshot_capacity-based-licenses.png[A screenshot that shows the amount of allocated capacity versus licensed capacity for the professional package and essentials package.]

...
* Marketplace subscriptions, which are hourly or annual subscriptions from your cloud provider's marketplace.
...
. Provide your Cloud Backup serial number and Cloud Manager System ID (this is called a Tenant ID on the support site) to obtain the license file.
+

...
summary: The Digital Wallet page enables you to manage licenses for Cloud Volumes ONTAP and Cloud Backup Service from a single location. You can add new licenses and update existing licenses.
---
...
[.lead]
The Digital Wallet page enables you to manage licenses for Cloud Volumes ONTAP and Cloud Backup Service from a single location. You can add new licenses and update existing licenses.
...
== Manage Cloud Backup Service licenses

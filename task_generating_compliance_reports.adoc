...
Age of Data:: For all working environments: Lists the number of files that have been modified based on certain date ranges.
For single working environments: Lists the number of files that have been created, accessed, and modified based on certain date ranges.
...
. Click *Governance*, and then click the *Download Data Mapping Report* button from the Governance Dashboard.
+

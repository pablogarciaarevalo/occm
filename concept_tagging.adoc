...
You can change or delete those tags using the Tagging service, and you can add new tags.
...
For information about Azure virtual machine tags, refer to https://docs.microsoft.com/en-us/azure/azure-resource-manager/management/tag-resources?tabs=json[Azure Documentation: Tagging your Azure resources^].

== Prerequisites

=== Verify your AWS Connector permissions

If you just created the Connector using Cloud Manager version 3.9.9 or greater, then you're all set. If you created the Connector using an earlier version of Cloud Manager, then you'll need to add some required permissions for the Cloud Manager IAM role to tag AWS EC2 instances:
...
If you just created the Connector using Cloud Manager version 3.9.10 or greater, then you're all set. If you created the Connector using an earlier version of Cloud Manager, then you'll need to add some required permissions for the Cloud Manager Operator IAM role to tag Azure resources:

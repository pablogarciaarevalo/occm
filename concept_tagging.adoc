...
If you just created the Connector using Cloud Manager version 3.9.9 or greater, then you're all set. If you created the Connector using an earlier version of Cloud Manager, then you'll need to add some newly required permissions for the Cloud Manager IAM role to tag AWS EC2 instances:

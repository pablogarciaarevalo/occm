...
NOTE: At this time you can't view or manage tags assigned to resources by the cloud provider. So you won't see tags applied from AWS or Azure, or labels assigned from GCP.

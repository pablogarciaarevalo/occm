...
* Enable Cloud Backup on created volumes
* Enable Cloud Compliance on created volumes (Cloud Volumes ONTAP volumes only)
...
* You can't use a template to create a volume on an existing aggregate. New volumes are created in a new aggregate.

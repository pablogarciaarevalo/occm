...
* Enable Cloud Backup on volumes (not applicable for Azure NetApp Files)
* Enable Cloud Data Sense on volumes
* Enable Replication on volumes (not applicable for Azure NetApp Files)

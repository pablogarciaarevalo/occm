...
Ensure that the network security group rules for Cloud Volumes ONTAP allow the load balancer to send TCP probes for the health probes that were created up above. This is allowed by default.

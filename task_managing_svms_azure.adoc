...
.. Use the following command if you want to create a NAS LIF on node 1.
+
[source,cli]
...
.. Use the following command if you want to create a NAS LIF on node 2 (for HA pairs only).
+
[source,cli]
...
.. Use the following command if you want to create an iSCSI LIF on node 1.
+
[source,cli]
network interface create -vserver <svm-name> -home-port e0a -address <iscsi-ip-address> -lif <lif-name> -home-node <name-of-node1> -data-protocol iscsi

.. Use the following command if you want to create an iSCSI LIF on node 2 (for HA pairs only).
+
[source,cli]

...
When you license Cloud Backup in Cloud Manager, you can enter the Cloud Backup serial number or you can upload the NLF license file. The steps below show how to get the NLF license file if you plan to use that method.

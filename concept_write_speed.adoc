...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_aws_990.html[Learn more about the Amazon EC2 instances that Cloud Volumes ONTAP supports^].
...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_azure_990.html[Learn more about the Azure VM types that Cloud Volumes ONTAP supports^].
...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_gcp_990.html[Learn more about the Google Cloud machine types that Cloud Volumes ONTAP supports^].

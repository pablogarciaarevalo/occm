...
+
For details, see link:reference_networking_aws.html[Networking requirements for Cloud Volumes ONTAP in AWS].
...
* link:task_deploying_otc_aws.html#licensing[Learn what's required in the wizard for the licensing method that you want to use.]
...
** *Node-based BYOL*: The 20-digit serial number (license key) is required for each node.
+
You'll enter the serial number on the *Charging Methods and NSS Account* page.
...
+
* link:concept_licensing.html[Learn about these charging methods].
* link:task_deploying_otc_aws.html#licensing-ha[Learn what's required in the wizard for the licensing method that you want to use.]

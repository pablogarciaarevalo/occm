...
* You should be prepared to do the following based on the licensing method that you want to use:

** *PAYGO free trial*: A Marketplace subscription is required.
+
You'll be prompted to subscribe on the *Details & Credentials* page.

** *Freemium*: A Marketplace subscription or NetApp Support Site account is required.
+
You can subscribe from the *Details & Credentials* page or enter the NetApp Support Site account on the *Charging Methods and NSS Account* page.

** *Capacity-based BYOL*: A Marketplace subscription or NetApp Support Site account is required. A Marketplace subscription is recommended for capacity-based charging in the event your account doesn't have a valid capacity-based license, or in the event that your allocated capacity exceeds the licensed capacity.
+
You can subscribe from the *Details & Credentials* page or enter the NetApp Support Site account on the *Charging Methods and NSS Account* page.

...
. *Choose your provider*: Select *Google Cloud Platform*.

. Complete the steps on the *Tiering Setup* page:

.. *Bucket*: Add a new Google Cloud Storage bucket or select an existing bucket.

.. *Storage Class Life Cycle Management*: Cloud Tiering manages the life cycle transitions of your tiered data. Data starts in the _Standard_ class, but you can create rules to move the data to other classes after a certain number of days.
+

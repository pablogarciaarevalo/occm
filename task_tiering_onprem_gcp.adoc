...
+
If you choose *Keep data in this storage class*, then the data remains in the that storage class.
link:reference_google_support.html[See supported storage classes^].
+

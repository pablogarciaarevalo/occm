...
NOTE: If you are planning to select a lower cost storage class where your tiered data will transition to after a certain number of days, you must ensure that there are no other rules applied to the selected bucket.

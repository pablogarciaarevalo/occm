...
.. *Storage Class*: Select the storage class that you want to transition the data to after 30 days.
+
link:reference_google_support.html[See supported storage classes^]. If you choose Standard, then the data remains in that storage class.

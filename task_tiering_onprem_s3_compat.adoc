...
[role="quick-margin-para"]
A Cloud Tiering BYOL license is required when tiering data to S3-compatible object storage. If you don't currently have a Cloud Tiering license, link:task_licensing_cloud_tiering.html#use-a-cloud-tiering-byol-license[see how to add a tiering license now].
...
Licensing::
A Cloud Tiering BYOL license is required when tiering data to S3-compatible object storage. If you don't currently have a Cloud Tiering license, mailto:ng-cloud-tiering@netapp.com?subject=Licensing[contact us if you need to purchase one], and then link:task_licensing_cloud_tiering.html#add-cloud-tiering-byol-licenses-to-your-account[add it to your account from the Cloud Manager Digital Wallet].

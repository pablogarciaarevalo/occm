...
==== image:number1.png[number 1] Prepare to tier data to S3-compatible object storage

[role="quick-margin-para"]
You need the following:

[role="quick-margin-list"]
* An AFF or FAS system with all-SSD aggregates that's running ONTAP 9.4 or later, and a connection over a user-specified port to the S3-compatible object storage. link:task_discovering_ontap.html[Learn how to discover a cluster].
...
[role="quick-margin-para"]
After your free trial ends, pay for Cloud Tiering through a pay-as-you-go subscription from your cloud provider, a NetApp Cloud Tiering bring-your-own-license, or a combination of both:

[role="quick-margin-list"]
* To subscribe to the Cloud Manager PAYGO offering from the https://aws.amazon.com/marketplace/pp/B07QX2QLXX[AWS Marketplace^], https://azuremarketplace.microsoft.com/en-us/marketplace/apps/netapp.cloud-manager?tab=Overview[Azure Marketplace^], or https://console.cloud.google.com/marketplace/details/netapp-cloudmanager/cloud-manager?supportedpurview=project&rif_reserved[GCP Marketplace^], click *Subscribe* and follow the prompts.

* To pay using a Cloud Tiering BYOL license, mailto:ng-cloud-tiering@netapp.com?subject=Licensing[contact us if you need to purchase one], and then link:task_licensing_cloud_tiering.html#add-cloud-tiering-byol-licenses-to-your-account[add it to your account from the Cloud Manager Digital Wallet].
...
. *Choose your provider*: Select *S3 Compatible* and click *Continue*.
...
.What's next?
link:task_licensing_cloud_tiering.html[Be sure to subscribe to the Cloud Tiering service].

...
* An AFF or FAS system with all-SSD aggregates that's running ONTAP 9.8 or later, and a connection over a user-specified port to the S3-compatible object storage. link:task_discovering_ontap.html[Learn how to discover a cluster].
...
* An HTTPS connection over port 443 to your ONTAP cluster

...
When setting up a sync relationship, you can choose a Google Cloud bucket from different projects, if you provide the required permissions to the data broker's service account. link:task_sync_installing_gcp.html[Learn how to set up the service account].

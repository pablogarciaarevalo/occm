---
sidebar: sidebar
permalink: task_setting_up_transit_gateway_fsx.html
keywords: transit gateway, aws, fsx for ontap, fsx, transit gateway, floating ip, client access, nas, outside, vpc, virtual private cloud, route table

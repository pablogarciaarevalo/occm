...
summary: Complete a few steps to start scanning NFS or CIFS file shares directly with Cloud Compliance.
---
...
[.lead]
Complete a few steps to start scanning NFS or CIFS file shares directly with Cloud Compliance.
...
==== image:number3.png[Number 3] Add a group to identify the file shares
...
== Adding the group for the file shares
...
== Adding file shares to compliance scans
...
+
If you are adding additional file shares to an existing group, click *Add Shares*.
+

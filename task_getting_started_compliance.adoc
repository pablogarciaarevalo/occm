...
==== image:number3.png[Number 3] Enable Cloud Compliance and select the volumes to scan
...
+
image:screenshot_cloud_compliance_we_scan_config.png[A screenshot of the Configuration tab immediately after deploying the Cloud Compliance instance.]

...
[role="quick-margin-list"]
* To subscribe from the AWS Marketplace, https://aws.amazon.com/marketplace/pp/B07QX2QLXX[go to the Cloud Manager Marketplace offering^], click *Subscribe*, and then follow the prompts.

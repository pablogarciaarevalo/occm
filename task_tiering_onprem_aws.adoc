...
.. *Storage Class*: Select the S3 storage class that you want to transition the tiered data to after 30 days.
+
link:reference_aws_support.html[See supported storage classes^]. If you choose Standard, then the data remains in that storage class and no rules are applied.

...
. *Choose your provider*: Select *Microsoft Azure*.
...
.. *Access Tier Life Cycle Management*: Cloud Tiering manages the life cycle transitions of your tiered data. Data starts in the _Hot_ class, but you can create a rule to move the data to the _Cool_ class after a certain number of days.
+

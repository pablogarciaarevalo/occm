...
+
If you choose *Keep data in this access tier*, then the data remains in the _Hot_ access tier and no rules are applied.
link:reference_azure_support.html[See supported access tiers^].
+

...
.. *Access Tier Life Cycle Management*: Select the access tier that you want to transition the tiered data to and the number of days before the data will be moved, and click *Continue*.
+
If you choose *Keep data in this access tier*, then the data remains in the _Hot_ access tier and no rules are applied. For example, the screenshot below shows that tiered data will remain in the _Hot_ access tier.

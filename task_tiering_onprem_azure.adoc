...
+
<<Verify that you have the necessary Connector permissions,Verify that you have the necessary Connector permissions>> for the life cycle management feature. Note that the life cycle rule is applied to all blob containers in the selected storage account.

...
See the link:https://repo.cloudsync.netapp.com/gfc/Netapp%20GFC%20User%20Guide%201.0.3.pdf[NetApp Global File Cache User Guide^] for details.
...
See the link:https://repo.cloudsync.netapp.com/gfc/Netapp%20GFC%20User%20Guide%201.0.3.pdf[NetApp Global File Cache User Guide^] for additional details about licensing.
...
* A new Policy Configuration tab has been added to the Configuration Console to add prepopulation jobs from the GFC Core.
...
* The NetApp license registration and GFC subscription-based registration is only allowed by the cloud-based LMS. The on-premises LMS should use legacy licensing.
* The Configuration UI now adds jobs in prepopulation when the LMC uses hostnames instead of IP address for the LMS during configuration.

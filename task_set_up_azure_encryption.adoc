...
summary: Data is automatically encrypted on Cloud Volumes ONTAP in Azure using Azure Storage Service Encryption with Microsoft-managed keys. But you can use your own encryption keys instead by following the steps on this page.
---

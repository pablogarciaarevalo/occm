...
You must create an Amazon FSx for ONTAP working environment before adding volumes. You will need and AWS access key and secret key for an link:task_setting_up_permissions_fsx.html[IAM user with FSx for ONTAP permissions].

...
* In AWS, the performance tier can be General Purpose SSDs (gp2), Provisioned IOPS SSDs, or Throughput Optimized HDDs.
...
. Under *Aggregate Capacity Thresholds*, click *Aggregate free space ratio for data tiering*.

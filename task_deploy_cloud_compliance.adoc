...
keywords: cloud compliance, data sense, get started, deploy cloud compliance, outbound internet, endpoints, cloud compliance internet, web browser connectivity, cloud compliance access, privacy, compliance, on-premises, Data Sense
...
. Download the Cloud Data Sense software from the https://mysupport.netapp.com/site/products/all/details/cloud-compliance/downloads-tab/[NetApp Support Site^].
...
Cloud Data Sense (Cloud Compliance) was added to the Azure Marketplace subscription named *NetApp Cloud Manager* as of October 7, 2020. If you already have the original Azure *Cloud Manager* subscription it will not allow you to use Cloud Data Sense.

...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_azure_990.html[Supported configurations for Cloud Volumes ONTAP 9.8 in Azure^]
...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_limits_azure_990.html[Storage limits for Cloud Volumes ONTAP 9.8 in Azure]

...
. On the *Tags/Metadata* page, choose whether to save a key-value pair on all files transferred to the S3 bucket or to assign a metadata key-value pair on all files.
+

...
summary: You can provision additional NFS, CIFS, and iSCSI storage for your Cloud Volumes ONTAP systems from Cloud Manager by managing volumes and aggregates.
---

...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_gcp_990.html[Supported configurations for Cloud Volumes ONTAP 9.8 in GCP^]
...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_limits_gcp_990.html[Storage limits for Cloud Volumes ONTAP 9.8 in GCP]

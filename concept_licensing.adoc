...
* Available in three licensing options: Explore, Standard, and Premium | Technical support is included, but you must link:task_registering.html[activate support^]
a|
* Explore: 2 TB
* Standard: 10 TB
* Premium: 368 TB
...
* You can have up to 10 Freemium systems in your account | Community-based support only | 500 GB
...
* Provides a la carte licensing for Cloud Volumes ONTAP (file storage, block storage, or disaster recovery) and your choice of add-on services | Technical support is included | 2 PB
...
* Provides licensing for both Cloud Volumes ONTAP and Cloud Backup Service | Technical support is included | 2 PB

| Node-based license a|
* The previous generation BYOL for Cloud Volumes ONTAP
* Available for license renewals only | Technical support is included | 368 TB per license

...
* If the allocated capacity for a Cloud Volumes ONTAP system exceeds 500 GB, Cloud Manager converts the system to the Essentials package (which is a capacity-based license) and charging starts.
+

...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_aws_991.html[Supported configurations for Cloud Volumes ONTAP 9.9.1 in AWS^]
...
https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_limits_aws_991.html[Storage limits for Cloud Volumes ONTAP 9.9.1 in AWS^]

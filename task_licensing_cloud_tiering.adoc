...
Bring-your-own licenses provide 2-, 12-, 24-, or 36-month term licenses from NetApp. The BYOL Cloud Tiering license is a _floating_ license that you can use across multiple on-premises ONTAP clusters in your customer account. The total tiering capacity that you define in your Cloud Tiering license can be used by all of your on-prem clusters, making initial licensing and renewal licensing easy.
...
The *FabricPool* license that you may have used in the past to tier data to the cloud is being retired on August 20, 2021. It is being replaced by the *Cloud Tiering* license. Here are some thing you need to know about the new license:

* The Cloud Tiering license is a _floating_ license that you can use across multiple on-premises ONTAP clusters. This is different than in the past where you needed to purchase a _FabricPool_ license for _every_ cluster.
* The Cloud Tiering license must be registered in Cloud Manager in the Digital Wallet. It is not applied on each cluster.
* Existing tiering users are not affected until your FabricPool license expires - then you'll have to start using the new floating license.
...
** Users who are tiering data to IBM Cloud Object Storage or Alibaba Cloud Object Storage

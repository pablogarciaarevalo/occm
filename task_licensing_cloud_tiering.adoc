...
Here are some thing you need to know about the two licenses:
...
| Once configures, you can use the tiering service without a license for 30 days with the free trial. | Once configured, you can tier the first 10 TB of data for free.
|===
...
* If you're using a configuration that is supported in Cloud Manager, then you'll start using the new Cloud Tiering license when your license expires.

...
* <<More services supported in Government regions>>
...
The Cloud Compliance and Single File Restore services are now supported in Government regions in AWS and Azure.

!!link with list of what's not supported!!

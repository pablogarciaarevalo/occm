...
+
** *Capacity-based BYOL*: A capacity-based license purchased from NetApp enables you to pay for Cloud Volumes ONTAP by capacity. The license is associated with your NetApp account and supports multiple Cloud Volumes ONTAP systems. With a capacity-based license, each individual Cloud Volumes ONTAP system supports up to 2 PB of capacity using disks and data tiering to object storage.

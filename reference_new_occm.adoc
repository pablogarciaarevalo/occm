...
* When setting up a sync relationship to an AWS S3 bucket, Cloud Sync now shows a *Tags/Metadata* page. This page enables you to define the tags or metadata that you want to save on the objects in the target S3 bucket.
+

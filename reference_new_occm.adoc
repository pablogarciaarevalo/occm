...
* Cloud Volumes ONTAP 9.8 is now supported in the AWS Commercial Cloud Services (C2S) environment. link:??.html[Learn how to get started in C2S].
...
Cloud Volumes ONTAP 9.8 is now supported in the Azure Department of Defense (DoD) Impact Level 6 (IL6). link:??.html[Learn how to get started in the IL6 environment].

...
* allow direct API traffic when proxy is configured
...
link:task_managing_cloud_central_accounts.html#changing-the-account-name[Learn more about these options].

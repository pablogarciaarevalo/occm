...
+
image:screenshot_enabling_worm.png[A screenshot of the WORM option that you can enable when creating a volume.]
...
* Disable "Allow Blob public access" when creating a storage account in Azure

...
+
The following permissions enable Cloud Manager to remove resources from a resource group that belong to Cloud Volumes ONTAP in case of deployment failure or deletion:
+
[source,json]

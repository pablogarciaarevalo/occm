...
+
Be aware that https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_limits_aws_990.html[disk limits^] can prevent you from reaching the capacity limit by using disks alone. You can go beyond the disk capacity limit by link:concept_data_tiering.html[tiering inactive data to object storage].
+
...
* Cloud Backup now allows you to create a backup using a different account/subscription than used for your Cloud Volumes ONTAP system.
+

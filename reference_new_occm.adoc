...
* <<Amazon FSx for ONTAP is now supported>>
...
+
link:https://docs.netapp.com/us-en/occm/concept_fsx_aws.html[Learn about Amazon FSx for ONTAP]

* You can configure an FSx for ONTAP working environment in Cloud Manager.
+
link:https://docs.netapp.com/us-en/occm/task_manage_fsx_aws.html[Create an Amazon FSx for ONTAP working environment]
...
+
link:https://review.docs.netapp.com/us-en/occm_sep-2021-fsx/task_scanning_fsx.html#quick-start[Getting started with Cloud Data Sense for Amazon FSx for ONTAP]
...
+
link:https://review.docs.netapp.com/us-en/occm_sep_2021_backup/task_managing_backups.html#creating-a-manual-volume-backup-at-any-time[See how to create an on-demand backup].

* When configuring backups to Amazon S3 from an on-premises ONTAP system, now you can define a connection to a Private VPC Endpoint in the activation wizard. This allows you to use a network interface that connects you privately and securely to a service powered by AWS PrivateLink.
...
+
The GCP service account associated with the Connector needs the latest permissions to deploy Cloud Data Sense to GCP. link:https://review.docs.netapp.com/us-en/occm_sep_2021_cc/task_deploy_cloud_compliance.html#reviewing-prerequisites[See the 3 new permissions that are required].
...
+
link:https://review.docs.netapp.com/us-en/occm_sep_2021_tiering/task_licensing_cloud_tiering.html#use-a-cloud-tiering-byol-license[Learn more about the new Cloud Tiering license].
...
+
link:https://review.docs.netapp.com/us-en/occm_sep_2021_tiering/task_tiering_onprem_s3_compat.html[See how to tier data to S3-compatible object storage].
...
+
link:https://review.docs.netapp.com/us-en/occm_sep_2021_template/concept_tagging.html#resources-that-you-can-tag[See the Azure resources that you can tag].
+
The Cloud Manager Operator IAM role associated with the Connector needs the latest permissions to tag Azure resources. link:https://review.docs.netapp.com/us-en/occm_sep_2021_template/concept_tagging.html#verify-your-azure-connector-permissions[see the new permissions that are required].

* Some additional AWS EC2 resources can now be tagged. link:https://review.docs.netapp.com/us-en/occm_sep_2021_template/concept_tagging.html#resources-that-you-can-tag[See the AWS resources that you can tag].

=== A new Notification Service has been added

A new Notification service has been added that shows high level events, actions, and notifications for operations being performed in Cloud Manager.

...
* Cloud Volumes ONTAP now supports _General Purpose SSD (gp3)_ disks. gp3 disks are the lowest-cost SSDs that balance cost and performance for a broad range of workloads.
+

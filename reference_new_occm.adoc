...
+
link:https://review.docs.netapp.com/us-en/occm_sep_2021_fsx/concept_fsx_aws.html[Learn about Amazon FSx for ONTAP].

* You can configure an FSx for ONTAP working environment in Cloud Manager.
+
link:https://review.docs.netapp.com/us-en/occm_sep_2021_fsx/task_manage_fsx_aws.html[Create an Amazon FSx for ONTAP working environment].
...
+
link:https://review.docs.netapp.com/us-en/occm_sep-2021-fsx/task_scanning_fsx.html#quick-start[Get started with Cloud Data Sense for Amazon FSx for ONTAP].

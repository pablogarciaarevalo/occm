...
* Capacity-based licensing is now available for Cloud Volumes ONTAP.
+
...
+
Capacity-based licensing is available in the form of a package, either _Freemium_, _Essential_, or _Professional_.
+
With the introduction of capacity-based BYOL, the traditional node-based BYOL is now available for license renewals only.
+

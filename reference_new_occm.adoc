...
* Sort the export policy drop-down list
* Auto purge old Snapshot copies
* Add tags during EBS creation to support SCP policy
* Adjust retention period for Auto Tiering policy

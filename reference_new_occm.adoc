...
+
Learn more about these Cloud Volumes ONTAP charging methods (note from Ben: link pending)
+
...
* Cloud Manager now disables *Blob public access* when creating a storage account for Cloud Volumes ONTAP.

...
. In the _Select Source_ page, navigate to the backup file (snapshot) for the volume you want to restore. Select the *Working Environment*, the *Volume*, and the *Backup* that has the date/time stamp that you want to restore.
+

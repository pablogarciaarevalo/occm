...
summary: Cloud Data Sense is a data privacy and compliance service for Cloud Manager that scans your corporate data sources to identify the personal and sensitive data that resides in those files. Using Artificial Intelligence driven technology, Cloud Data Sense helps organizations understand data context and identify sensitive data.
---
...
[.lead]
Cloud Data Sense is a data privacy and compliance service for Cloud Manager that scans your corporate data sources to identify the personal and sensitive data that resides in those files. Using Artificial Intelligence driven technology, Cloud Data Sense helps organizations understand data context and identify sensitive data.

NOTE: *Cloud Compliance* was renamed to *Cloud Data Sense* in the June 2021 release.
...
* Add a custom status to a file so you can identify if the file needs attention or has been verified

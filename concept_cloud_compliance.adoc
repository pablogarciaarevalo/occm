...
[cols="18,22,60",width=90%,options="header"]
|===
| System size
| Specs
| Limitations
...
When deploying Data Sense in the cloud, email ng-contact-data-sense@netapp.com for assistance in selecting these smaller systems.

...
By default, Cloud Sync copies object storage metadata for several types of sync relationships. But you need to configure the data broker if you want to copy object storage metadata between the following types of sync relationships:

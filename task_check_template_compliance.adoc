...
You can view a drift report for a single resource, or run a report to download a report for all resources. Using this report you canassign actions to system admins to make changes that bring the resources back into compliance with the template.
...
To view a drift report for all resources that have been created from your templates, click image:button_download.png[] to download a .CSV file.

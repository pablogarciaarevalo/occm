...
+
The underlying EBS disk type can be either General Purpose SSD (gp2), Provisioned IOPS SSD (io1), Throughput Optimized HDD (st1), or Cold HDD (sc1). You can pair an EBS disk with Amazon S3 to link:concept_data_tiering.html[tier inactive data to low-cost object storage].
+
...
* https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_limits_aws_990.html[Review storage limits for Cloud Volumes ONTAP in AWS^]

* http://docs.netapp.com/us-en/cloud-volumes-ontap/reference_configs_aws_990.html[Review supported configurations for Cloud Volumes ONTAP in AWS^]
...
* https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_limits_azure_990.html[Review storage limits for Cloud Volumes ONTAP in Azure^]
...
* https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_limits_gcp_990.html[Review storage limits for Cloud Volumes ONTAP in GCP^]

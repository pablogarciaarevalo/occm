...
** You should have a link:task_creating_connectors_azure.html[Connector that is associated with your workspace].
+
...
. If you're prompted, link:task_creating_connectors_azure.html[create a Connector].
...
| Security group | If you choose an existing security group, then it must meet Cloud Volumes ONTAP requirements. link:reference_networking_azure.html#security-group-rules-for-cloud-volumes-ontap[View the default security group].
...
* link:task_deploying_otc_azure.html#licensing[Learn what's required in the wizard for the licensing method that you want to use].

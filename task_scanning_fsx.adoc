...
Data Sense must be deployed in the cloud when scanning FSx for ONTAP volumes, and it must be deployed in the same region as the volumes you wish to scan.

== Enabling Cloud Data Sense in your working environments

You can enable Cloud Data Sense on your FSx for ONTAP volumes.

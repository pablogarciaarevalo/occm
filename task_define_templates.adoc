...
. Details: You can enter a Working Environment Name if you are using this action in a template without first creating a volume. Otherwise, leave this field as "Editable."

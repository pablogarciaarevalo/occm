...
* You must have an active Cloud Volumes ONTAP working environment.
...
. In the _Select_Primary Action_ page, select *Create Volume in Cloud Volumes ONTAP* as the type of resource you want to create, and click *Next*.
+

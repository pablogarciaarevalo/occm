...
* If you plan to enable Replication in the template, and the template is for an on-prem ONTAP volume, ensure that your environment has an active SnapMirror license.

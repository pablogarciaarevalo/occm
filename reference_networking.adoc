...
* link:task_scanning_object_storage.html[Cloud Compliance for generic S3 object storage]
* link:task_scanning_file_shares.html[Cloud Compliance for non-NetApp NFS or CIFS file shares]
* link:task_scanning_databases.html[Cloud Compliance for databases]
* link:task_scanning_onedrive.html[Cloud Compliance for OneDrive accounts]
